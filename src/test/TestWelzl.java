...
public class TestWelzl {
	...
	public void test() {
		...
		System.out.println("Nombre des tests passes pour la version recursive : " + nbTestsRecOK);
		System.out.println("Nombre des tests passes pour la version iterative : " + nbTestsItOK);
